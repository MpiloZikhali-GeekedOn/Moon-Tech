...
from datetime import datetime, timedelta
 # Removed AI model imports for rule-based chatbot only
import warnings
import http.client
import json
...
# Add session configuration to fix login issues
...
warnings.filterwarnings('ignore')
 ...
 # Removed global AI model instance
...
def load_properties():
    try:
        ...
        if not os.path.exists(file_path):
            ...
            print("Directory contents:", os.listdir('Moon-Tech'))
...
# Mpilo AI Chatbot Configuration
CHATBOT_SYSTEM_PROMPT = """
You are Mpilo, an AI chatbot for Stokvel Sami, a smart stokvel management and shopping recommendation platform. 

Your role:
- Help users understand how to use Stokvel Sami features
- Provide guidance on stokvel management, recommendations, wishlist, budget settings
- Answer questions about the website functionality
- Be friendly, helpful, and concise
- Always introduce yourself as Mpilo

Stokvel Sami Features:
1. STOKVEL MANAGEMENT: Users can create and manage stokvel groups
2. RECOMMENDATIONS: Users can get AI-powered product recommendations based on their budget
3. PROPERTY RECOMMENDATIONS: Users can find property investment opportunities
4. WISHLIST: Users can save products to a wishlist and download as PDF
5. BUDGET: Users can set and manage their shopping budget
6. SEARCH: Users can search for specific products
7. CHAT: Mpilo (you) helps users navigate the website

Guidelines:
- Always be helpful and encouraging
- Provide step-by-step instructions when needed
- If you don't know something specific about Stokvel Sami, say so politely
...
"""
 ...
 # Removed model loading function for rule-based chatbot only
...
def get_fallback_response(user_message):
    ...
    if any(word in user_message for word in ["recommend", "recommendation", "suggest"]):
        return "Hi! I'm Mpilo, your Stokvel Sami assistant. To get recommendations, go to the 'Recommend' page, enter your budget, and click 'Get Recommendations'. Our AI will suggest the best products for your budget! 🤖"
    ...
    elif any(word in user_message for word in ["stokvel", "group", "savings"]):
        return "Hello! I'm Mpilo. Stokvel Sami helps you create and manage stokvel groups. You can set savings goals, invite friends, and track your progress together! 👥"

    elif any(word in user_message for word in ["hello", "hi", "hey"]):
        return "Hello! I'm Mpilo, your Stokvel Sami AI assistant. I can help you with stokvel management, recommendations, wishlist, budget settings, and more! How can I assist you today? 🤖"

    elif any(word in user_message for word in ["help", "support"]):
        return "I'm Mpilo, and I'm here to help! You can ask me about stokvel management, recommendations, wishlist, budget settings, or any other Stokvel Sami features. What would you like to know? 🤝"

    elif any(word in user_message for word in ["name", "who are you", "what are you"]):
        return "I'm Mpilo! I'm your AI assistant for Stokvel Sami. I help users navigate the website, understand features, and get the most out of their stokvel and shopping experience. How can I help you today? 😊"

    else:
        return "Hi! I'm Mpilo, your Stokvel Sami AI assistant! You can ask me about stokvel management, recommendations, wishlist, budget settings, or how to use any features. What would you like to know? 😊"


# ---------------- Routes ---------------- #
@app.route('/')
def index():
    # Check if user is logged in and pass user info to template
...
def create_stokvel():
    ...
    if request.method == 'POST':
        ...
        c.execute('''
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        ''', (
            user_id, name, description, category, target_amount, duration_months, max_members, grow_with_sami,
            join_code))
...
def invite_friends(stokvel_id):
    if 'user_id' not in session:
        flash("Please log in to invite friends.")
        return redirect(url_for('login'))
...
def join_stokvel():
    if 'user_id' not in session:
        flash("Please log in to join a stokvel.")
        return redirect(url_for('login'))
...
def save_wishlist():
    try:
        ...
        p.drawString(100, 800, "Your Stokvel Sami Wishlist")
        ...
        buffer.seek(0)
        return send_file(buffer, as_attachment=True, download_name='stokvel_sami_wishlist.pdf',
...
def send_wishlist_sms():
    try:
        ...
        # Base message
        message = f"Stokvel Sami Wishlist: {item_count} items, Total: ${total:.2f}. "
...
def mpilo_chatbot():
    ...
    try:
        ...
        # Get rule-based chatbot response
...
# ---------------- Helper Functions ---------------- #
def send_sms_invite(phone_number, stokvel_name, join_code):
    """Send SMS invitation to join a stokvel"""
    # This is a placeholder function - in a real implementation, you would integrate with an SMS API
    message = f"Join my stokvel '{stokvel_name}' on Stokvel Sami! Use code: {join_code}"
...
if __name__ == '__main__':
    ...
    # No AI model loading needed for rule-based chatbot
